...
public class HardwareDaemonWriterSocketCollectorImpl implements HardwareDaemonWriter {
...
//    private ThreadLocal<Socket> mSocket;
    ...
    public HardwareDaemonWriterSocketCollectorImpl(Config config) throws IOException{
